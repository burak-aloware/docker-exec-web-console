...
func ExecContainer(ws *websocket.Conn) {
	...
	dockerUnitTestRunnerJson := bytes.NewBufferString("{\"AttachStdin\":true,\"AttachStdout\":true,\"AttachStderr\":true,\"Tty\":true,\"Cmd\":[\"/bin/bash\",\"-c\",\"APP_ENV=testing && /bin/bash /var/www/html/init-test-db.sh\"]}")
